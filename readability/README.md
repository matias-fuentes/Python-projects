[Readability](https://cs50.harvard.edu/college/2020/fall/psets/6/readability/#readability)
==========================================================================================
...
-   Write, in a file called `readability.py` in `~/pset6/readability/`, a program that first asks the user to type in some text, and then outputs the grade level for the text, according to the Coleman-Liau formula, exactly as you did in [Problem Set 2](https://cs50.harvard.edu/college/2020/fall/psets/2/), except that your program this time should be written in Python.
...
```
check50 cs50/problems/2020/fall/sentimental/readability
```
...
1.  Download your `readability.py` file by control-clicking or right-clicking on the file in CS50 IDE's file browser and choosing Download.
2.  Go to CS50's [Gradescope page](https://www.gradescope.com/courses/157004).
3.  Click "Problem Set 6: Readability".
4.  Drag and drop your `readability.py` file to the area that says "Drag & Drop". Be sure it has the correct filename!
5.  Click "Upload".

You should see a message that says "Problem Set 6: Sentimental (Readability) submitted successfully!" You won't see a score just yet, but if you see the message then we've received your submission!
